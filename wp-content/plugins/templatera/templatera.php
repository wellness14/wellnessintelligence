...
function plugin_activated(){
	$default_template = get_option( 'incubator_default_templates' );
	global $vc_template_manager;
	$vc_template_manager = new VcTemplateManager( $dir );
			if ( 'yes' !== $default_template ) {
				$vc_template_manager->settingsFieldImportSanitize();
				update_option( 'incubator_default_templates', 'yes' );
	}	
}
