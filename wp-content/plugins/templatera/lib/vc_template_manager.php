...
if ( ! class_exists( 'VcTemplateManager' ) ) {
	...
	class VcTemplateManager {
		...
		public function buildTab( Vc_Settings $settings ) {
			...
			$settings->addField( $this->settings_tab, __( '', 'templatera' ), 'import', array(
				$this,
		...
		public function settingsFieldImportSanitize() {
			$file = get_template_directory_uri() . '/core/templates/templates.xml';
				$post_types = get_post_types( array( 'public' => true ) );
				$roles = get_editable_roles();
				$templateras = simplexml_load_file( $file );
